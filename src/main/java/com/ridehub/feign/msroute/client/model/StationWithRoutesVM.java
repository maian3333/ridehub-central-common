...
public class StationWithRoutesVM implements Serializable {
  ...
  @jakarta.annotation.Nullable
  private List<@Valid RouteDTO> routes = new ArrayList<>();
  ...
  public StationWithRoutesVM routes(@jakarta.annotation.Nullable List<@Valid RouteDTO> routes) {
  ...
  public List<@Valid RouteDTO> getRoutes() {
    return routes;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROUTES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRoutes(@jakarta.annotation.Nullable List<@Valid RouteDTO> routes) {
    this.routes = routes;
  }
