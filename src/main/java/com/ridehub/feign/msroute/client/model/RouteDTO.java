...
@JsonPropertyOrder({
  ...
  RouteDTO.JSON_PROPERTY_BASE_FARE,
...
public class RouteDTO implements Serializable {
 ...
 @Size(min=0,max=40)
  ...
  public RouteDTO baseFare(@jakarta.annotation.Nonnull BigDecimal baseFare) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, routeDTO.id) &&
        ...
        Objects.equals(this.baseFare, routeDTO.baseFare) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, routeCode, distanceKm, baseFare, createdAt, updatedAt, isDeleted, deletedAt, deletedBy, origin, destination);
  }
