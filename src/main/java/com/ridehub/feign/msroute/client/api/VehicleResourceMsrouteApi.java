...
import com.ridehub.feign.msroute.client.model.VehicleDetailVM;
import com.ridehub.feign.msroute.client.model.VehicleTypeFactorUpdateDTO;
import com.ridehub.feign.msroute.client.model.VehicleWithSeatCountVM;
...
public interface VehicleResourceMsrouteApi extends ApiClient.Api {
  ...
  * but this one also exposes the Http response headers
   ...
   * 
   * 
   * @param vehicleTypeFactorUpdateDTO  (required)
   * @return Integer
   */
  @RequestLine("PUT /api/vehicles/type-factor")
  @Headers({
    "Content-Type: application/json",
    "Accept: */*",
  })
  Integer updateTypeFactorByType(@jakarta.annotation.Nonnull VehicleTypeFactorUpdateDTO vehicleTypeFactorUpdateDTO);

  /**
   * 
   * Similar to <code>updateTypeFactorByType</code> but it also returns the http response headers .
   * 
   * @param vehicleTypeFactorUpdateDTO  (required)
   * @return A ApiResponse that wraps the response boyd and the http headers.
   */
  ...
  ApiResponse<Integer> updateTypeFactorByTypeWithHttpInfo(@jakarta.annotation.Nonnull VehicleTypeFactorUpdateDTO vehicleTypeFactorUpdateDTO);
