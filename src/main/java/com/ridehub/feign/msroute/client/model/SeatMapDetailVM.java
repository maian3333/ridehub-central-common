...
public class SeatMapDetailVM implements Serializable {
  ...
  public SeatMapDetailVM floors(@jakarta.annotation.Nullable List<@Valid FloorDTO> floors) {
  ...
  public SeatMapDetailVM seatsByFloorId(@jakarta.annotation.Nullable Map<String, List<@Valid SeatDTO>> seatsByFloorId) {
    
    this.seatsByFloorId = seatsByFloorId;
    return this;
  }

  public SeatMapDetailVM putSeatsByFloorIdItem(String key, List<@Valid SeatDTO> seatsByFloorIdItem) {
