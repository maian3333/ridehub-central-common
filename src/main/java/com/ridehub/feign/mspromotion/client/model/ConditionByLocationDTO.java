...
public class ConditionByLocationDTO implements Serializable {
  ...
  @jakarta.annotation.Nullable
  private Set<@Valid ConditionLocationItemDTO> items = new LinkedHashSet<>();
  ...
  public ConditionByLocationDTO items(@jakarta.annotation.Nullable Set<@Valid ConditionLocationItemDTO> items) {
  ...
  public Set<@Valid ConditionLocationItemDTO> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable Set<@Valid ConditionLocationItemDTO> items) {
    this.items = items;
  }
