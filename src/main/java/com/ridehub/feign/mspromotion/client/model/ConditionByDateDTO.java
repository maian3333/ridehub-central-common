...
public class ConditionByDateDTO implements Serializable {
  ...
  @jakarta.annotation.Nullable
  private Set<@Valid ConditionDateItemDTO> items = new LinkedHashSet<>();
  ...
  public ConditionByDateDTO items(@jakarta.annotation.Nullable Set<@Valid ConditionDateItemDTO> items) {
  ...
  public Set<@Valid ConditionDateItemDTO> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable Set<@Valid ConditionDateItemDTO> items) {
    this.items = items;
  }
