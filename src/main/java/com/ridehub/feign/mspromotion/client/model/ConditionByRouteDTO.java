...
public class ConditionByRouteDTO implements Serializable {
  ...
  @jakarta.annotation.Nullable
  private Set<@Valid ConditionRouteItemDTO> items = new LinkedHashSet<>();
  ...
  public ConditionByRouteDTO items(@jakarta.annotation.Nullable Set<@Valid ConditionRouteItemDTO> items) {
  ...
  public Set<@Valid ConditionRouteItemDTO> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@jakarta.annotation.Nullable Set<@Valid ConditionRouteItemDTO> items) {
    this.items = items;
  }
