...
@JsonPropertyOrder({
  ...
  AppUserDTO.JSON_PROPERTY_STATISTICS
})
...
public class AppUserDTO implements Serializable {
 ...
 @Pattern(regexp="^[^@\\s]+@[^@\\s]+\\.[^@\\s]+$")
  ...
  public AppUserDTO statistics(@jakarta.annotation.Nullable UserStatisticsDTO statistics) {
  ...
  @JsonProperty(JSON_PROPERTY_STATISTICS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStatistics(@jakarta.annotation.Nullable UserStatisticsDTO statistics) {
    this.statistics = statistics;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, appUserDTO.id) &&
        ...
        Objects.equals(this.statistics, appUserDTO.statistics);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, keycloakId, email, phoneNumber, firstName, lastName, dateOfBirth, isVerified, isActive, lastLoginAt, createdAt, updatedAt, isDeleted, deletedAt, deletedBy, profile, statistics);
  }
