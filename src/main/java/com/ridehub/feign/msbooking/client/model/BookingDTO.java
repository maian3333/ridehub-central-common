...
@JsonPropertyOrder({
  ...
  BookingDTO.JSON_PROPERTY_BOOKED_AT,
  BookingDTO.JSON_PROPERTY_CUSTOMER_ID,
  BookingDTO.JSON_PROPERTY_IDEMPOTENCY_KEY,
  BookingDTO.JSON_PROPERTY_TRIP_ID,
  BookingDTO.JSON_PROPERTY_LOCK_GROUP_ID,
  BookingDTO.JSON_PROPERTY_EXPIRES_AT,
  BookingDTO.JSON_PROPERTY_TIMEOUT_MINUTES,
...
public class BookingDTO implements Serializable {
  ...
  public BookingDTO bookedAt(@jakarta.annotation.Nonnull OffsetDateTime bookedAt) {
  ...
  public BookingDTO idempotencyKey(@jakarta.annotation.Nullable String idempotencyKey) {
 ...
 @Size(min=0,max=80)
  ...
  public BookingDTO tripId(@jakarta.annotation.Nonnull Long tripId) {
  ...
  public BookingDTO lockGroupId(@jakarta.annotation.Nullable String lockGroupId) {
 ...
 @Size(min=0,max=36)
  ...
  public BookingDTO expiresAt(@jakarta.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public BookingDTO timeoutMinutes(@jakarta.annotation.Nullable Integer timeoutMinutes) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, bookingDTO.id) &&
        ...
        Objects.equals(this.bookedAt, bookingDTO.bookedAt) &&
        Objects.equals(this.customerId, bookingDTO.customerId) &&
        Objects.equals(this.idempotencyKey, bookingDTO.idempotencyKey) &&
        Objects.equals(this.tripId, bookingDTO.tripId) &&
        Objects.equals(this.lockGroupId, bookingDTO.lockGroupId) &&
        Objects.equals(this.expiresAt, bookingDTO.expiresAt) &&
        Objects.equals(this.timeoutMinutes, bookingDTO.timeoutMinutes) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, bookingCode, status, quantity, totalAmount, bookedAt, customerId, idempotencyKey, tripId, lockGroupId, expiresAt, timeoutMinutes, createdAt, updatedAt, isDeleted, deletedAt, deletedBy, invoice, paymentTransaction);
  }
